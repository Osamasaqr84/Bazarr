 ...
 */
public class Container_Fragment2 extends Fragment implements View.OnClickListener,
    ...
    public static Container_Fragment2 newInstance(int position, String name) {
        Log.i("namesub", name);
        Container_Fragment2 fragment = new Container_Fragment2();
