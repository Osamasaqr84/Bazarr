...
public class SearchBycity extends AppCompatActivity {
    ...
    String cattype = "0",idz ="0",text;
    int type =0,page = 2,cityid = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        manager = new LinearLayoutManager(SearchBycity.this);
...
//        }
      //  type = intent.getIntExtra("type",0);
        ...
        cityid = intent.getIntExtra("cidi",0);
        trans(cattype,type);
        ...
        count.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SearchBycity.this, String.valueOf(kk.size()), Toast.LENGTH_SHORT).show();
            }
        });
                ...
                public void onSuccess(String result) {
                    ...
                    if (!result.equals("")) {
                        ...
                        try {
                            ...
                            adapter = new myads_adapter(SearchBycity.this, Cat_arrayList);
                        ...
                        Toast.makeText(SearchBycity.this, getString(R.string.error), Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onError(String error) {
                    Toast.makeText(SearchBycity.this,getString(R.string.connectionerror), Toast.LENGTH_SHORT).show();
                }
            }, SearchBycity.this, "http://alsog.net/api/advertises/alldata/"
                    +  "1/0/0/" + String.valueOf(cityid) + "/1", false);
