 ...
 */
public class Container_Fragment4 extends Fragment implements View.OnClickListener,
    ...
    public static Container_Fragment4 newInstance(int position, String name) {
        Log.i("namesub", name);
        Container_Fragment4 fragment = new Container_Fragment4();
...
//        Log.i("id", String.valueOf(bundle.getInt("type")));
    ...
    private void trans(String type,String id, String image) {
            ...
            Log.i("Link", "http://alsog.net/api/Advertises/alldata/"
                +  type + "/" + id + "/" + image + "/" + helper.getCityId() +"/1");
        Log.i("getCityId",image);
            ...
            public void onSuccess(String result) {
                ...
                if (!result.equals("")) {
                    ...
                    try {
                        ...
                        //    helper.setNEXT_URL(nexturl);
                        //       linkk = nexturl;
                        Log.i("dataaaaa", String.valueOf(ads));
                        for (int index = 0; index < ads.length(); index++) {
                            JSONObject catgrey = ads.getJSONObject(index);
                            JSONObject cityjson = catgrey.getJSONObject("city");
                            Log.i("name2", String.valueOf(catgrey));
...
//                }
        ...
        }, getActivity(), "http://aldelalh.com/api/Advertises/alldata/"
