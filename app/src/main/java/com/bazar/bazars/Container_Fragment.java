...
import static com.bazar.bazars.Connect_TO_Server.MyApplication.getInstance;


/**
 * A simple {@link Fragment} subclass.
 */
public class Container_Fragment extends Fragment implements View.OnClickListener,
    ...
    public ArrayList<AlldataModel.DataBean> ads_arrayList2;
    ...
    public static Container_Fragment newInstance(int position,String name) {
        Log.i("namesub", name);
        Container_Fragment fragment = new Container_Fragment();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        ads_arrayList2 = new ArrayList<AlldataModel.DataBean>();
...
//        Log.i("id", String.valueOf(bundle.getInt("type")));
        //  getAlldata(String.valueOf(bundle.getString("type")),String.valueOf(bundle.getInt("key5")),helper.getImagePreference());
...
//                 }
               ...
               public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                 ...
                 {
                     Log.i("onScrolled", "onScrolled: "+dy);
                     MainActivity.tabLayout.setVisibility(View.GONE);
...
//                 }
    ...
    private void transNext(String type,String id, String image) {
        ...
        ads_listView.getRecycledViewPool().clear();
...
//                }
    ...
    private AlldataModel allOrdersModel;
    Call<AlldataModel> calls;
    int count =0;
    private  void getAlldata(String type,String id, String image)
    {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        calls = apiService.getAlldata(type,id,image, helper.getCityId() ,"1");
        Log.d("before", apiService.toString() + "ffff");

        calls.enqueue(new Callback<AlldataModel>(){
            @Override
            public void onResponse(Call<AlldataModel> call, final Response<AlldataModel> response) {
                Log.d("response",response.toString());
                if (response.body() != null) {
                    allOrdersModel = response.body();
