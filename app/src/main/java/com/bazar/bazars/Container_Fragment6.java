 ...
 */
public class Container_Fragment6 extends Fragment implements View.OnClickListener,
    ...
    public static Container_Fragment6 newInstance(int position, String name) {
        Log.i("namesub", name);
        Container_Fragment6 fragment = new Container_Fragment6();
