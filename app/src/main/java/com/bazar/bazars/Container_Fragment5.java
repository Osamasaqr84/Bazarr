 ...
 */
public class Container_Fragment5 extends Fragment implements View.OnClickListener,
    ...
    public static Container_Fragment5 newInstance(int position, String name) {
        Log.i("namesub", name);
        Container_Fragment5 fragment = new Container_Fragment5();
